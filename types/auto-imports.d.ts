...
declare global {
  ...
  const connectToMetamask: typeof import('../src/components/Connector')['connectToMetamask']
  const copyFn: typeof import('../src/utils/index')['copyFn']
  ...
  const useClientSize: typeof import('../src/hooks/useClientSize')['default']
  const useClinetSize: typeof import('../src/hooks/useClinetSize')['default']
  ...
  const useMatchBreakpoints: typeof import('../src/hooks/useClientSize')['default']
  const useMatchPoint: typeof import('../src/hooks/useMatchPoint')['default']
